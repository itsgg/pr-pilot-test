...
describe("Metrics Collector", () => {
  ...
  describe("recordCommentStats", () => {
    ...
    it("should handle empty issues array", () => {
      ...
      assert.strictEqual(
        Object.keys(collector.metrics.issues_by_category).length,
        0,
      );
    });
  });
  ...
  describe("recordCustomMetric", () => {
    it("should record custom metrics", () => {
      ...
      assert.strictEqual(
        collector.metrics.custom_metrics.custom_field,
        "custom_value",
      );
    });
  });
  ...
  describe("recordApiCall", () => {
    ...
    it("should accumulate multiple API calls", () => {
      ...
      collector.recordApiCall("claude", {
        duration_ms: 500,
        success: true,
        retries: 0,
      });
